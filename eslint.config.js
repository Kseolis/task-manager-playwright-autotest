...
export default [
  ...
  },
  {
    ...
    rules: {
      ...
      'no-unused-vars': ['warn', { argsIgnorePattern: '^_', varsIgnorePattern: '^_', caughtErrorsIgnorePattern: '^_' }], // Warning вместо error для неиспользуемых переменных
      'no-empty-pattern': 'warn', // Warning для пустых паттернов в fixtures
    },
  },
  {
    files: ['scripts/**/*.js'],
